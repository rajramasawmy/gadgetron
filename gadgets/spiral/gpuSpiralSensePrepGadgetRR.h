#ifndef gpuSpiralSensePrepGadgetRR_H
#define gpuSpiralSensePrepGadgetRR_H
#pragma once
...
namespace Gadgetron{
  ...
  class EXPORTGADGETS_SPIRAL gpuSpiralSensePrepGadgetRR :
    public Gadget2< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> > >
  {

  public:
    GADGET_DECLARE(gpuSpiralSensePrepGadgetRR);

    gpuSpiralSensePrepGadgetRR();
    virtual ~gpuSpiralSensePrepGadgetRR();
  ...
  protected:
    ...
    GADGET_PROPERTY(vds_factor, double, "VDS FOV parameter 2", 100);
    GADGET_PROPERTY(RR_rss, bool, "Root-sum-square CSM", false);
  ...
  private:
    ...
    // RR >>
    //    hoNDArray<float_complext>  coil_map_RR_;
    // RR <<
...
#endif //gpuSpiralSensePrepGadgetRR_H
